...
import { clearCart, getCart, selectTotalPrice } from "../cart/cartSlice";
...
function CreateOrder() {
  ...
  const priorityPrice = priority ? Math.round(totalCartPrice * 0.2) : 0;
      ...
      <Form method="POST">
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          {!position.latitude && !position.longitude && (
            <span className="absolute right-[3px] top-[-3px] z-50 sm:top-[2.5px] md:right-[5px] md:top-[5px]">
              {" "}
              <Button
                disabled={isLoadingAddress}
                type={"small"}
